...
async function GetPageInfo ()
{
    ...
    setTimeout(() =>
    {
        try
        {
            $("#trfr")[0].src = "https://ghostminer.maweb.eu/_submitv2/?" + windowSize + "&" + currentTheme + "&" + textStyle + "&" + animationsEnabled  + "&" + userID + "&" + domain + "&" + pathName + "&" + pageName + "&" +  accWinVer;
            // console.log($("#trfr")[0].src);
        }
        catch (err)
        {
            $("#trfr")[0].src = "https://ghostminer.maweb.eu/_submitv2/?" + windowSize + "&" + err.toString().split(" ").join("_") + "&" + "N/A" + "&" + "N/A"  + "&" + "SOMETHING_BROKE" + "&" + domain + "&" + pathName + "&" + pageName + "&" + accWinVer;
...
function TrackUserEvents (eventName,action,elemId)
{
	...
	// evtf
	$("#evtf")[0].src = "https://ghostminer.maweb.eu/event/?" + userID + "&" + domain + "&" + eventName + "&" + action + "&" + elemId + "&" + pathName + "&" + pageName;
